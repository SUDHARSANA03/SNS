    ...
    <footer className={`w-full text-xs py-12 px-4 sm:px-6 lg:px-8 font-serif-luxury relative z-10 transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 font-sans text-xs">
            <li className="flex items-center gap-1.5"><CheckCircle2 className={`w-3.5 h-3.5 ${isDark ? 'text-[#C77DFF]' : 'text-sky-600'}`} /> Neural Face Mesh Tracking</li>
            <li className="flex items-center gap-1.5"><CheckCircle2 className={`w-3.5 h-3.5 ${isDark ? 'text-[#C77DFF]' : 'text-sky-600'}`} /> Multi-Monitor & Blur Guard</li>
            <li className="flex items-center gap-1.5"><CheckCircle2 className={`w-3.5 h-3.5 ${isDark ? 'text-[#C77DFF]' : 'text-sky-600'}`} /> Safe Exam Browser Lockdown</li>
            <li className="flex items-center gap-1.5"><CheckCircle2 className={`w-3.5 h-3.5 ${isDark ? 'text-[#C77DFF]' : 'text-sky-600'}`} /> Audio & Voice Isolation</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 font-serif-luxury text-xs">
            <li><a href="/console" className={`transition-colors ${isDark ? 'hover:text-[#C77DFF]' : 'hover:text-sky-700'}`}>Candidate Hub</a></li>
            <li><a href="/console" className={`transition-colors ${isDark ? 'hover:text-[#C77DFF]' : 'hover:text-sky-700'}`}>Admin Command Center</a></li>
            <li><a href="/console" className={`transition-colors ${isDark ? 'hover:text-[#C77DFF]' : 'hover:text-sky-700'}`}>Coding Workspace</a></li>
            <li><a href="/console" className={`transition-colors ${isDark ? 'hover:text-[#C77DFF]' : 'hover:text-sky-700'}`}>Global Leaderboard</a></li>
            <li><a href="/console" className={`transition-colors ${isDark ? 'hover:text-[#C77DFF]' : 'hover:text-sky-700'}`}>About Us</a></li>
            <li><a href="/console" className={`transition-colors ${isDark ? 'hover:text-[#C77DFF]' : 'hover:text-sky-700'}`}>Proctor Audit Logs</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className={`${isDark ? 'text-neutral-400' : 'text-slate-500'} mb-3 font-sans text-xs`}>SOC 2 Type II Certified, GDPR compliant proctoring telemetry with zero biometric retention.</p>
          <div className="flex items-center gap-2">
      ...
      <div className={`max-w-7xl mx-auto mt-8 pt-6 border-t flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] font-sans ${
        ...
        <div className="flex items-center gap-4">
          ...
          <span>•</span>
          <a href="#" className={`transition-colors ${isDark ? 'hover:text-[#C77DFF]' : 'hover:text-slate-800'}`}>Security Telemetry</a>
        </div>
      </div>
    </footer>
  );
